...
In Can Tho's second electoral district, the 2016 election saw four candidates competed for two seats in the VNA. Among them, Nguyen Van Quyen, a 63-year-old native of Ninh Binh, is the central candidate. He is the Party Secretary and Chairman of the Vietnam Lawyers Association -- a state-sanctioned organization of legal professionals operating in parallel with the Vietnam Bar Association. Outside of his role in the Lawyers Association, Nguyen Van Quyen also serves in the central leadership of Vietnam Fatherland Front (VFF) -- an umbrella organization to which all mass organizations must be affiliated -- and in a 16-delegate committee on judicial reforms within the CPV central leadership. His multiple roles as leader of a central-level mass organization and a high-ranking CPV official earn him a nomination by the central leadership.
...
\begin{table}[htb]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}[t]{@{}llllll@{}}
			\toprule
			Name            & Age & Gender & Central/Local & Professional Profile                                                                    & Vote Share (\%) \\ \midrule
			Tran Quoc Trung & 56  & Male   & Local         & \begin{tabular}[c]{@{}l@{}}Can Tho Party Secretary\\ Member, CPV Central Committee\end{tabular} & 74.35           \\
			Ngo Trung Quan  & 56  & Male   & Local         & \begin{tabular}[c]{@{}l@{}}Member, VFF Central Committee\\ Local Business Owner\end{tabular}    & 49.09           \\
			\textbf{Nguyen Van Quyen} &
			63 &
			Male &
			Central &
			\begin{tabular}[c]{@{}l@{}}Chairman, Vietnam Lawyers Association\\ Deputy Party Secretary and Vice Chairman, VFF Central Committee\\ Member, CPV Committee on Judicial Reforms\end{tabular} &
			47.12 \\
			Dao Thi Sa Ron  & 43  & Female & Local         & Vice Principal, Can Tho Boarding School for Ethnic Minorities                           & 28.24           \\ \bottomrule
		\end{tabular}%
	}
\end{table}
...
\input{figure/200422_table_promo}
