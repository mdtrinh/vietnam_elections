...
digit.test <- function(num, digit=2, plot=TRUE, axe.y=FALSE, title=NULL, xlab=NULL, ylab=NULL) {
    require(ggplot2)
...
digit.test(turnout2011$turnout.voters, digit=1)
digit.test(turnout2011$turnout.voters, digit=2)
digit.test(turnout2011$turnout.voters, digit=3)

digit.test(turnout2011$invalid.votes, digit=1)
digit.test(turnout2011$invalid.votes, digit=2)
digit.test(turnout2011$invalid.votes, digit=3)

digit.test(result2016$vote, digit=1)
digit.test(result2016$vote, digit=2)
digit.test(result2016$vote, digit=3)


### Chi-square test as benchmarks

# note that only invalid votes should have first digit followed by Benford's laws
chisq.benftest(turnout$invalid.votes, digits=1)
chisq.benftest(turnout$invalid.votes, digits=2)
