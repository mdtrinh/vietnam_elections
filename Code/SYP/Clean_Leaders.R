...
setwd("/media/minh/Dropbox (MIT)/Documents/Works/Vietnam Elections/Data/Provincial Leaders/")
...
# provnames <- read.csv("../Vietnam National Budget/Provinces.csv", stringsAsFactors=F)
# leaders$prov <- lookup.clean(leaders$province, provnames)
