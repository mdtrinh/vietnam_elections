...
ggsave("../../figure/200202_impute_results_2011.png", width = 6, height = 3)
...
ggplot(vhlss_prov, aes(x = variable, y = proportion)) +
  geom_point() +
  geom_violin(alpha = .3) +
  xlab("Outcomes") +
  ylab("Proportion") +
  scale_x_discrete(labels = c("Communes\nwith Post-Office", "Communes\nwith Electricity", "Communes\nwith Primary School", "Households\nin Poverty")) +
  theme_bw() + 
...
ggsave("../../figure/200202_impute_results_2007.png", width = 6, height = 3)
