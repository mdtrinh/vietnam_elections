...
#source("../../Code/Winter 2019/Functions.R") # already called within each file below
source("../../Code/Winter 2019/Clean_Budget.R")
source("../../Code/Winter 2019/Clean_Profile.R")
source("../../Code/Winter 2019/Clean_Results.R")
source("../../Code/Winter 2019/Clean_Leaders.R")
source("../../Code/Winter 2019/Clean_PAPI.R")
source("../../Code/Winter 2019/Clean_PCI.R")
