...
# without covariates
lm_2016_1a <- lm(net.trans.change.log ~ defeat + defeat.2016 +
...
lm_2016_1b <- lm(net.trans.change.log ~ defeat + defeat.2016 +
                   total.rev.log.lag +
                   factor(prov) + factor(year),
                 data = dat_2016_1) # just lm
summary(lm_2016_1b)
...
lm_2016_1c <- lm(net.trans.change.log ~ defeat + defeat.2016 +
...
# without covariates
lm_2016_pa <- lm(net.trans.change.log ~ defeat + defeat.2016 +
                  factor(prov) + factor(year),
...
# without covariates
lm_2016_1_placebo2014a <- lm(net.trans.change.log ~ defeat_placebo2014 + defeat.2016 +
                          factor(prov) + factor(year),
...
# adding time-variant covariate: lagged total revenue
lm_2016_1_placebo2014b <- lm(net.trans.change.log ~ defeat_placebo2014 + defeat.2016 +
                               total.rev.log.lag +
                               factor(prov) + factor(year),
                             data = dat_2016_1_placebo2014) # just lm
...
lm_2016_1_placebo2014c <- lm(net.trans.change.log ~ defeat_placebo2014 + defeat.2016 +
                               num.districts.2016 + num.districts.5.2016 + num.centralnominees.2016 +
                               factor(year),
                             data = dat_2016_1_placebo2014) # just lm
...
# without covariates
lm_2016_1_placebo2015a <- lm(net.trans.change.log ~ defeat_placebo2015 + defeat.2016 +
                              factor(prov) + factor(year),
...
# adding time-variant covariate: lagged total revenue
lm_2016_1_placebo2015b <- lm(net.trans.change.log ~ defeat_placebo2015 + defeat.2016 +
                              total.rev.log.lag +
                              factor(prov) + factor(year),
                            data = dat_2016_1_placebo2015) # just lm
...
lm_2016_1_placebo2015c <- lm(net.trans.change.log ~ defeat_placebo2015 + defeat.2016 +
                              num.districts.2016 + num.districts.5.2016 + num.centralnominees.2016 +
                              factor(year),
                            data = dat_2016_1_placebo2015) # just lm
...
# without covariates
lm_2016_1_placebo2016a <- lm(net.trans.change.log ~ defeat_placebo2016 + defeat.2016 +
                              factor(prov) + factor(year),
...
# adding time-variant covariate: lagged total revenue
lm_2016_1_placebo2016b <- lm(net.trans.change.log ~ defeat_placebo2016 + defeat.2016 +
                              total.rev.log.lag +
                              factor(prov) + factor(year),
                            data = dat_2016_1_placebo2016) # just lm
...
# adding time-invariant covariates instead of prov FEs
lm_2016_1_placebo2016c <- lm(net.trans.change.log ~ defeat_placebo2016 + defeat.2016 +
                              num.districts.2016 + num.districts.5.2016 + num.centralnominees.2016 +
                              factor(year),
                            data = dat_2016_1_placebo2016) # just lm
...
panelView(net.trans.change.log ~ defeat, data = dat_2016synth_1, index = c("prov", "year"))

system.time(
  synth_2016_1 <- gsynth(net.trans.change.log ~ treat + defeat + total.rev.log, 
...
print(synth_2016_p)
plot(synth_2016_p)
plot(synth_2016_p, type = "counterfactual", raw = "all")
...
system.time(
  synth_2016_1_placebo2014 <- gsynth(net.trans.change.log ~ treat + defeat + total.rev.log, 
...
system.time(
  synth_2016_p_placebo2014 <- gsynth(net.trans.change.log ~ treat + defeat + total.rev.log.lag, 
...
system.time(
  synth_2016_1_placebo2015 <- gsynth(net.trans.change.log ~ treat + defeat + total.rev.log.lag, 
...
system.time(
  synth_2016_p_placebo2015 <- gsynth(net.trans.change.log ~ treat + defeat + total.rev.log.lag, 
...
system.time(
  synth_2016_1_placebo2016 <- gsynth(net.trans.change.log ~ treat + defeat + total.rev.log.lag, 
