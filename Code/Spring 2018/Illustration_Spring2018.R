...
colnames(balance_table) <- c("Control Mean ($N = 7$)", "Treated Mean ($N = 5$)", "Std. Diff. in Means", "RI Std. Error", "RI p-value", "OLS Std. Error", "OLS p-value",
...
sink("../../figure/190618_table_balance.tex")
...
stargazer(lm_2016_1a, lm_2016_1b, lm_2016_1c,
          ...
          label = "tab:lfe_main",
          style = "apsr",
          out = "../../figure/190618_reg_table.tex",
...
# function to plot results -- adapted from vietnamdata::plot.riFit()
...
stargazer(lm_dev_2016_1a, lm_dev_2016_1b, lm_dev_2016_1c,
          ...
          label = "tab:lfe_mech",
          style = "apsr",
          out = "../../figure/190618_reg_table_mech.tex",
