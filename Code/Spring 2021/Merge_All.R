...
#source("../../Code/Spring 2021/Functions.R") # already called within each file below
source("../../Code/Spring 2021/Clean_Budget.R")
source("../../Code/Spring 2021/Clean_Profile.R")
source("../../Code/Spring 2021/Clean_Results.R")
source("../../Code/Spring 2021/Clean_Leaders.R")
...
##### Save Treatment to Files #####
save(provinces2007, provinces2011, provinces2016,
