...
profile2011 <- read.xlsx2("Profile_2011_coded_updated.xls", stringsAsFactors=F, sheetIndex=1)
...
# central nominator variable
profile2016$central_nominator_leaders <- as.numeric(profile2016$central_nominator %in% 
                                                      c("party", "president", "government", "armed forces", "justice"))
