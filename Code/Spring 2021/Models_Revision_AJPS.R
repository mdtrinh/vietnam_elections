#### THIS FILE CONTAINS ALL THE MAIN MODELS THAT ARE DONE IN RESPONSE TO FIRST ROUND OF REVIEW AT AJPS####
...
setwd("G:/Users/Minh Trinh/Dropbox (MIT)/Documents/Works/Vietnam Elections/Data/Working Data")
...
dat_2011_1_placebo2009 <- dat_lme_2011 %>%
...
## placebo 1: persistent change as if election was held in 2008 st outcome is in 2009

# 2011 results under placebo 1
dat_2011_p_placebo2009 <- dat_lme_2011 %>%
  mutate(defeat_placebo2009 = defeat.2011 * as.numeric(year >= 2009)) %>%
  filter(year < 2012)

# without covariates
lm_2011_p_placebo2009a <- lm(net.trans.change.log ~ defeat_placebo2009 + defeat.2011 +
                               factor(prov) + factor(year),
                             data = dat_2011_p_placebo2009) # just lm
summary(lm_2011_p_placebo2009a)
vcov_2011_p_placebo2009a <- cluster.vcov(lm_2011_p_placebo2009a, cluster = ~ prov)
coeftest(lm_2011_p_placebo2009a, vcov = vcov_2011_p_placebo2009a)

# adding time-variant covariate: lagged total revenue
lm_2011_p_placebo2009b <- lm(net.trans.change.log ~ defeat_placebo2009 + defeat.2011 +
                               total.rev.log.lag +
                               factor(prov) + factor(year),
                             data = dat_2011_p_placebo2009) # just lm
summary(lm_2011_p_placebo2009b)
vcov_2011_p_placebo2009b <- cluster.vcov(lm_2011_p_placebo2009b, cluster = ~ prov)
coeftest(lm_2011_p_placebo2009b, vcov = vcov_2011_p_placebo2009b)

# adding time-invariant covariates instead of prov FEs
lm_2011_p_placebo2009c <- lm(net.trans.change.log ~ defeat_placebo2009 + defeat.2011 +
                               num.districts.2011 + num.districts.5.2011 + num.centralnominees.2011 +
                               factor(year),
                             data = dat_2011_p_placebo2009) # just lm
summary(lm_2011_p_placebo2009c)
vcov_2011_p_placebo2009c <- cluster.vcov(lm_2011_p_placebo2009c, cluster = ~ prov)
coeftest(lm_2011_p_placebo2009c, vcov = vcov_2011_p_placebo2009c)


## placebo 2: one-year change as if election was held in 2009 st outcome is in 2010

# 2011 results under placebo 1
dat_2011_1_placebo2010 <- dat_lme_2011 %>%
...
## placebo 2: persistent change as if election was held in 2009 st outcome is in 2010

# 2011 results under placebo 1
dat_2011_p_placebo2010 <- dat_lme_2011 %>%
  mutate(defeat_placebo2010 = defeat.2011 * as.numeric(year >= 2010)) %>%
  filter(year < 2012)

# without covariates
lm_2011_p_placebo2010a <- lm(net.trans.change.log ~ defeat_placebo2010 + defeat.2011 +
                               factor(prov) + factor(year),
                             data = dat_2011_p_placebo2010) # just lm
summary(lm_2011_p_placebo2010a)
vcov_2011_p_placebo2010a <- cluster.vcov(lm_2011_p_placebo2010a, cluster = ~ prov)
coeftest(lm_2011_p_placebo2010a, vcov = vcov_2011_p_placebo2010a)

# adding time-variant covariate: lagged total revenue
lm_2011_p_placebo2010b <- lm(net.trans.change.log ~ defeat_placebo2010 + defeat.2011 +
                               total.rev.log.lag +
                               factor(prov) + factor(year),
                             data = dat_2011_p_placebo2010) # just lm
summary(lm_2011_p_placebo2010b)
vcov_2011_p_placebo2010b <- cluster.vcov(lm_2011_p_placebo2010b, cluster = ~ prov)
coeftest(lm_2011_p_placebo2010b, vcov = vcov_2011_p_placebo2010b)

# adding time-invariant covariates instead of prov FEs
lm_2011_p_placebo2010c <- lm(net.trans.change.log ~ defeat_placebo2010 + defeat.2011 +
                               num.districts.2011 + num.districts.5.2011 + num.centralnominees.2011 +
                               factor(year),
                             data = dat_2011_p_placebo2010) # just lm
summary(lm_2011_p_placebo2010c)
vcov_2011_p_placebo2010c <- cluster.vcov(lm_2011_p_placebo2010c, cluster = ~ prov)
coeftest(lm_2011_p_placebo2010c, vcov = vcov_2011_p_placebo2010c)

## placebo 3: one-year change as if election was held in 2010 st outcome is in 2011

# 2011 results under placebo 2
dat_2011_1_placebo2011 <- dat_lme_2011 %>%
...
## placebo 3: persistent change as if election was held in 2010 st outcome is in 2011

# multiple year effect is the same as one-year effect

# 2011 results under placebo 2
dat_2011_p_placebo2011 <- dat_lme_2011 %>%
  mutate(defeat_placebo2011 = defeat.2011 * as.numeric(year == 2011)) %>%
  filter(year < 2012)

# without covariates
lm_2011_p_placebo2011a <- lm(net.trans.change.log ~ defeat_placebo2011 + defeat.2011 +
                               factor(prov) + factor(year),
                             data = dat_2011_p_placebo2011) # just lm
summary(lm_2011_p_placebo2011a)
vcov_2011_p_placebo2011a <- cluster.vcov(lm_2011_p_placebo2011a, cluster = ~ prov)
coeftest(lm_2011_p_placebo2011a, vcov = vcov_2011_p_placebo2011a)

# adding time-variant covariate: lagged total revenue
lm_2011_p_placebo2011b <- lm(net.trans.change.log ~ defeat_placebo2011 + defeat.2011 +
                               total.rev.log.lag +
                               factor(prov) + factor(year),
                             data = dat_2011_p_placebo2011) # just lm
summary(lm_2011_p_placebo2011b)
vcov_2011_p_placebo2011b <- cluster.vcov(lm_2011_p_placebo2011b, cluster = ~ prov)
coeftest(lm_2011_p_placebo2011b, vcov = vcov_2011_p_placebo2011b)

# adding time-invariant covariates instead of prov FEs
lm_2011_p_placebo2011c <- lm(net.trans.change.log ~ defeat_placebo2011 + defeat.2011 +
                               num.districts.2011 + num.districts.5.2011 + num.centralnominees.2011 +
                               factor(year),
                             data = dat_2011_p_placebo2011) # just lm
summary(lm_2011_p_placebo2011c)
vcov_2011_p_placebo2011c <- cluster.vcov(lm_2011_p_placebo2011c, cluster = ~ prov)
coeftest(lm_2011_p_placebo2011c, vcov = vcov_2011_p_placebo2011c)

#### Coefficient plot for main regression results + placebo results
lfe_2011_plot_dat <- data.frame(ATT = sapply(list(lm_2011_pa, lm_2011_pb, lm_2011_pc,
                                                  lm_2011_p_placebo2009a, lm_2011_p_placebo2009b, lm_2011_p_placebo2009c,
                                                  lm_2011_p_placebo2010a, lm_2011_p_placebo2010b, lm_2011_p_placebo2010c,
                                                  lm_2011_p_placebo2011a, lm_2011_p_placebo2011b, lm_2011_p_placebo2011c), 
                                             function(mod){
                                               coef(mod)[2]
                                             }),
                                se = sapply(list(vcov_2011_pa, vcov_2011_pb, vcov_2011_pc,
                                                 vcov_2011_p_placebo2009a, vcov_2011_p_placebo2009b, vcov_2011_p_placebo2009c,
                                                 vcov_2011_p_placebo2010a, vcov_2011_p_placebo2010b, vcov_2011_p_placebo2010c,
                                                 vcov_2011_p_placebo2011a, vcov_2011_p_placebo2011b, vcov_2011_p_placebo2011c), 
                                            function(vcov){
                                              sqrt(diag(vcov))[2]
                                            })) %>%
...
# multiple year effect is the same for one-year effect
rdd_2011_p_placebo2011 <- rdd_2011_1_placebo2011
...
rdd_2011_results <- grid.arrange(layout_matrix = lay,
                            ...
                            y_axe(-20,20),
                            ri_plot(rdd_2011_p, scale=F, xmin=-20, xmax=20, title = "Election in 2011"),
                            ri_plot(rdd_2011_p_placebo2009, scale=F, xmin=-20, xmax=20, title = "Election in 2008"),
                            ri_plot(rdd_2011_p_placebo2010, scale=F, xmin=-20, xmax=20, title = "Election in 2009"),
                            ri_plot(rdd_2011_p_placebo2011, scale=F, xmin=-20, xmax=20, title = "Election in 2010"),
                            y_axe(-20,20) + scale_x_continuous(position = "top"),
                            ri_annotate(rdd_2011_p, show_wilcox = FALSE),
                            ri_annotate(rdd_2011_p_placebo2009, show_wilcox = FALSE),
                            ri_annotate(rdd_2011_p_placebo2010, show_wilcox = FALSE),
                            ri_annotate(rdd_2011_p_placebo2011, show_wilcox = FALSE))
...
source("../../Code/Fall 2020/Clean_Covariates.R")
...
dat_balance_lme <- plan %>% 
  ...
  select(prov, total.rev, total.exp,
         ...
         defeat.2011) %>%
  inner_join(covariates %>% filter(year == 2010), by = "prov") %>%
...
treatment.2011.observed <- treatment_generate_2011(candidates2011rdd, years = c(2005:2018))
...
dat_synth_2011 <- plan %>%
  ...
  filter(prov!="Ha Noi" & prov!="TP HCM") %>%
  filter(prov!="Long An")
panelView(net.trans.log ~ defeat, data = dat_synth_2011, index = c("prov", "year"))

## One year change

dat_2011synth_1 <- dat_synth_2011 %>%
  mutate(treat = defeat.2011*as.numeric(year==2012)) %>%
  #filter(defeat.2011!=0 | closewin.2011!=0) %>%
  filter(year < 2013) %>%
  drop_na(net.trans.log)
panelView(net.trans.log ~ treat, data = dat_2011synth_1, index = c("prov", "year"))

system.time(
  synth_2011_1 <- gsynth(net.trans.log ~ treat + defeat, 
...
dat_2011synth_p <- dat_synth_2011 %>%
  mutate(treat = defeat.2011*as.numeric(year>=2012)) %>%
...
system.time(
  synth_2011_p <- gsynth(net.trans.log ~ treat + defeat, 
...
dat_2011synth_1_placebo2010 <- dat_rdd_2011 %>%
...
system.time(
  synth_2011_1_placebo2010 <- gsynth(net.trans.log ~ treat + defeat, 
...
dat_2011synth_p_placebo2010 <- dat_rdd_2011 %>%
  mutate(treat = defeat.2011*as.numeric(year>=2010)) %>%
  #filter(defeat.2011!=0 | closewin.2011!=0) %>%
  filter(year < 2012) %>%
  drop_na(net.trans.log)
...
system.time(
  synth_2011_p_placebo2010 <- gsynth(net.trans.log ~ treat + defeat, 
...
dat_2011synth_1_placebo2011 <- dat_rdd_2011 %>%
...
system.time(
  synth_2011_1_placebo2011 <- gsynth(net.trans.log ~ treat + defeat, 
...
synth_results_table <- grid.arrange(layout_matrix = lay,
                                    ...
                                    gsynth_plot(synth_2011_p, xmin = -6, xmax = 4, ymin = -5, ymax = 5),
...
# 2007 only
dat_2007_1 <- dat_lme_2007 %>%
  filter(year < 2009)

# without covariates
lm_2007_1a <- lm(net.trans.change.log ~ defeat + defeat.2007 +
                   factor(prov) + factor(year),
...
# 2007 results under placebo 1
dat_2007_1_placebo2006 <- dat_lme_2007 %>%
...
## placebo 1: persistent change as if election was held in 2005 st outcome is in 2006

# 2007 results under placebo 1
dat_2007_p_placebo2006 <- dat_lme_2007 %>%
  mutate(defeat_placebo2006 = defeat.2007 * as.numeric(year >= 2006)) %>%
  filter(year < 2011)

# without covariates
lm_2007_p_placebo2006a <- lm(net.trans.change.log ~ defeat_placebo2006 + defeat.2007 +
                               factor(prov) + factor(year),
                             data = dat_2007_p_placebo2006) # just lm
summary(lm_2007_p_placebo2006a)
vcov_2007_p_placebo2006a <- cluster.vcov(lm_2007_p_placebo2006a, cluster = ~ prov)
coeftest(lm_2007_p_placebo2006a, vcov = vcov_2007_p_placebo2006a)

# adding time-variant covariate: lagged total revenue
lm_2007_p_placebo2006b <- lm(net.trans.change.log ~ defeat_placebo2006 + defeat.2007 +
                               total.rev.log.lag +
                               factor(prov) + factor(year),
                             data = dat_2007_p_placebo2006) # just lm
summary(lm_2007_p_placebo2006b)
vcov_2007_p_placebo2006b <- cluster.vcov(lm_2007_p_placebo2006b, cluster = ~ prov)
coeftest(lm_2007_p_placebo2006b, vcov = vcov_2007_p_placebo2006b)

# adding time-invariant covariates instead of prov FEs
lm_2007_p_placebo2006c <- lm(net.trans.change.log ~ defeat_placebo2006 + defeat.2007 +
                               num.districts.2007 + num.districts.5.2007 + num.centralnominees.2007 +
                               factor(year),
                             data = dat_2007_p_placebo2006) # just lm
summary(lm_2007_p_placebo2006c)
vcov_2007_p_placebo2006c <- cluster.vcov(lm_2007_p_placebo2006c, cluster = ~ prov)
coeftest(lm_2007_p_placebo2006c, vcov = vcov_2007_p_placebo2006c)

## placebo 2: one-year change as if election was held in 2006 st outcome is in 2007

# 2007 results under placebo 2
dat_2007_1_placebo2007 <- dat_lme_2007 %>%
...
## placebo 2: persistent change as if election was held in 2006 st outcome is in 2007

# persistent effect is identical to one-year effect
# because there is only one post-treatment year

# 2007 results under placebo 2
dat_2007_p_placebo2007 <- dat_lme_2007 %>%
  mutate(defeat_placebo2007 = defeat.2007 * as.numeric(year == 2007)) %>%
  filter(year < 2008)

# without covariates
lm_2007_p_placebo2007a <- lm(net.trans.change.log ~ defeat_placebo2007 + defeat.2007 +
                               factor(prov) + factor(year),
                             data = dat_2007_p_placebo2007) # just lm
summary(lm_2007_p_placebo2007a)
vcov_2007_p_placebo2007a <- cluster.vcov(lm_2007_p_placebo2007a, cluster = ~ prov)
coeftest(lm_2007_p_placebo2007a, vcov = vcov_2007_p_placebo2007a)

# adding time-variant covariate: lagged total revenue
lm_2007_p_placebo2007b <- lm(net.trans.change.log ~ defeat_placebo2007 + defeat.2007 +
                               total.rev.log.lag +
                               factor(prov) + factor(year),
                             data = dat_2007_p_placebo2007) # just lm
summary(lm_2007_p_placebo2007b)
vcov_2007_p_placebo2007b <- cluster.vcov(lm_2007_p_placebo2007b, cluster = ~ prov)
coeftest(lm_2007_p_placebo2007b, vcov = vcov_2007_p_placebo2007b)

# adding time-invariant covariates instead of prov FEs
lm_2007_p_placebo2007c <- lm(net.trans.change.log ~ defeat_placebo2007 + defeat.2007 +
                               num.districts.2007 + num.districts.5.2007 + num.centralnominees.2007 +
                               factor(year),
                             data = dat_2007_p_placebo2007) # just lm
summary(lm_2007_p_placebo2007c)
vcov_2007_p_placebo2007c <- cluster.vcov(lm_2007_p_placebo2007c, cluster = ~ prov)
coeftest(lm_2007_p_placebo2007c, vcov = vcov_2007_p_placebo2007c)
...
# Difference in means
mean(rdd_2007_1$beta[1] > rdd_2007_1$beta[-1], na.rm = TRUE)
mean(rdd_2007_1$beta[1] < rdd_2007_1$beta[-1], na.rm = TRUE)

2*min(mean(rdd_2007_1$beta[1] > rdd_2007_1$beta[-1], na.rm = TRUE),
      mean(rdd_2007_1$beta[1] < rdd_2007_1$beta[-1], na.rm = TRUE))

plot(density(rdd_2007_1$beta, na.rm = TRUE))
...
# Difference in means
mean(rdd_2007_p$beta[1] > rdd_2007_p$beta[-1], na.rm = TRUE)
mean(rdd_2007_p$beta[1] < rdd_2007_p$beta[-1], na.rm = TRUE)

2*min(mean(rdd_2007_p$beta[1] > rdd_2007_p$beta[-1], na.rm = TRUE),
      mean(rdd_2007_p$beta[1] < rdd_2007_p$beta[-1], na.rm = TRUE))

plot(density(rdd_2007_p$beta, na.rm = TRUE))
...
# Difference in means
2*min(mean(rdd_2007_1_placebo2006$beta[1] > rdd_2007_1_placebo2006$beta[-1], na.rm = TRUE),
      mean(rdd_2007_1_placebo2006$beta[1] < rdd_2007_1_placebo2006$beta[-1], na.rm = TRUE))

plot(density(rdd_2007_1_placebo2006$beta, na.rm = TRUE))
...
# Difference in means
2*min(mean(rdd_2007_p_placebo2006$beta[1] > rdd_2007_p_placebo2006$beta[-1], na.rm = TRUE),
      mean(rdd_2007_p_placebo2006$beta[1] < rdd_2007_p_placebo2006$beta[-1], na.rm = TRUE))

plot(density(rdd_2007_p_placebo2006$beta, na.rm = TRUE))
abline(v = rdd_2007_p_placebo2006$beta[1])

# Wilcoxon rank sum
2*min(mean(rdd_2007_p_placebo2006$wilcox[1] > rdd_2007_p_placebo2006$wilcox[-1]),
      mean(rdd_2007_p_placebo2006$wilcox[1] < rdd_2007_p_placebo2006$wilcox[-1]))

plot(density(rdd_2007_p_placebo2006$wilcox))
abline(v = rdd_2007_p_placebo2006$wilcox[1])
...
# Difference in means
2*min(mean(rdd_2007_1_placebo2007$beta[1] > rdd_2007_1_placebo2007$beta[-1], na.rm = TRUE),
      mean(rdd_2007_1_placebo2007$beta[1] < rdd_2007_1_placebo2007$beta[-1], na.rm = TRUE))

plot(density(rdd_2007_1_placebo2007$beta, na.rm = TRUE))
...
stargazer(lm_repeat_1a, 
          ...
          style = "apsr",
          out = "../../figure/200916_reg_table_repeat.tex",
